...
*/
// 10 - and now we need to convert our gltf file into a sx file or a file we can
// work in the browser but now we want to " Converting a glTF to Draco glTF " and to that
...
export default function ThreeDModelsAnimationComponent() {
    ...
    useEffect( () => {
        ...
        if (
            ...
            pRef.current.textContent = 'Choose a color below and move your cursor over the shoe to rotate it';

            firstLiRef.current.style.display  = 'none';
            secondLiRef.current.style.display = 'none';

            firstLiRef.current.style.color  = 'tranparent';
            secondLiRef.current.style.color = 'tranparent';
    ...
    async function handleResize( e ) {
        ...
        // test
        // console.log( browserWidth );
        // console.log( h1Ref.current.style.display );
        // console.log( firstLiRef.current.style.color );
        // console.log( works );
        ...
        if (
            ...
            pRef.current.textContent = 'To rotate the 3D models, move your cursor over the models';
            ...
            >
                ...
                <div className={ styles.threeDModelsContainerDiv1Div3 }>
                    ...
                    <p
                        ref={ pRef }
                    >
                        To rotate the 3D models, move your cursor over the models
                    </p>
