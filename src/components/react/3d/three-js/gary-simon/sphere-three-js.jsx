...
export default function SphereThreejsComponent() {
    ...
    useEffect( () => {
        ...
        // make sure we remove the sphere and other three.js assets on component
        // unmount
        return () => {
            ...
            function( entries, handMoveFontIconObserver ) { 
                ...
                entries.forEach( ( entry ) => {
                    ...
                    if ( entry.isIntersecting ) {
                        ...
                        // ==============================
                        // remember, on my iPad the cursor was not completely fading out
                        // at the end of the animation so I commented out the code for
                        // now ( see below )
                        // ==============================
    ...
    async function setThreeScene( e ) {
        ...
        */
        ...
        // and far point and remember, to get the same default settings as RTF, we do
        ...
        const renderer = new THREE.WebGLRenderer(
            {
                antialias          : true,
                alpha              : true,
                premultipliedAlpha : false, // from stackoverflow :
                // " https://stackoverflow.com/questions/41981879/three-js-premultipliedalpha-true-does-not-affect-the-output-of-gl-readpixels "
                // " premultipliedAlpha tells browser how you store
                // colours in the default framebuffer: multiplied by alpha or not. It's needed
                // for compositor to correctly blend your webgl content with the rest of the page.
                // The flags doesn't affect values written to the framebuffer. If you set it to
                // true or false it's your responsibility to return correct colour values from
                // fragment shaders "
                canvas             : canvasRef.current
            }
        ); // alpha : true makes background transparent
        ...
        // match the supported pixel ratio of the browser and RTF does this by default
...
/*
        ...
        // call the tick function to kick things off
        tick();
*/
