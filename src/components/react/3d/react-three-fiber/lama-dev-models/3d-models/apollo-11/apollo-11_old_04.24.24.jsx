...
// in a ver uneasy way and the whole process was a bad user experience; however,
// on the second page visit everything was find
//
// to fix this issue, I 
// ==============================
...
// and this worked and the result was that upon page load I was see the cube textures
...
// to the above " Hydration failed " problem
// ==============================

// ==============================
// 1 - components/3d/lama-dev-models/3d-models/apollo-11.js
// 2 - components/3d/lama-dev-models/3d-models/apollo-11.module.scss
...
// import in the Loader, OrbitControls, Perspective Camera, Stage components
import { Loader, OrbitControls, PerspectiveCamera, Stage } from '@react-three/drei';
...
export default function Apollo11Component() {
