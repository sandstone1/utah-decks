...
import PolaroidCameraModel from './polaroid-camera-v2';
...
export default function PolaroidCameraComponent() {
    ...
    return (
        ...
        <div className={ styles.polaroidCameraContainer }>
...
} // end of PolaroidCameraComponent
