...
export default function MeshComponent() {
    ...
    // const texture = useTexture( '/textures/linen.png' );
    ...
    return (
        ...
        // ==============================
        // mesh 6 - 3D rectangular blob with a plain blue background
        // ==============================
        ...
        >
            ...
            >
                ...
                <MeshDistortMaterial
                    ...
                    // map={ texture }
                    attach='material' // comment this out and apply map={ texture }
