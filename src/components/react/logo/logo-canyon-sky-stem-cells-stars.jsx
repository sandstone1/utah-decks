...
import styles from './logo-canyon-sky-stem-cells-stars.module.scss';



export default function LogoCanyonSkyStemCellsComponent() {
    ...
    return (
        ...
        <div className={ styles.logoCanyonSkyStemCellsContainer }>
...
} // end of LogoCanyonSkyStemCellsComponent
