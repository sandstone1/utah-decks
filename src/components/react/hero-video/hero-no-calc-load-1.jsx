...
import styles from './hero-no-calc-load-1.module.scss';
...
export default function HeroVideoComponent() {
    ...
    const videos = [
        ...
        //{ video : '/videos/adobe_preview_297.mov',        type : 'video/mp4', alt : 'A swirling blue background' },
...

            {
                ...
                loading === false ? (
                    ...
                    >
                        ...
                        <h2>
                            Results-Driven Digital Marketing Agency in Salt Lake City
                        </h2>
