...
import styles from './hero-no-calc-no-load-3.module.scss';
...
/*
        ...
        if ( isMobile ) {
            ...
            // set the currentVideoIndex so that we only play the second video
            // on mobile devices
...
*/
                ...
                */ 
                requestAnimationFrame( () => {
                    ...
                    if ( div3Ref.current ) {
                        ...
                        div3Ref.current.style.transform = 'translateZ( 0 )';

                    } // end of if ( div3Ref.current )

                } ); // end of requestAnimationFrame()

            } // end of if

        }, 9400 ); // end of setTimeout 1
    ...
    // IMPORTANT!
    //
    // 4 - to eliminate the inital page jank, I also tried to add the the top hero container code to
    // <style is:inline></style> in the main-layout.js file
    /*
        .hero-video-container {
                grid-area             : div1;
                grid-column           : 1 / -1;
                display               : grid;
                grid-template-columns : minmax( 8rem, 1fr ) repeat( 20, minmax( min-content, 12rem ) ) minmax( 8rem, 1fr );
                ...
                z-index               : 1;
                height                : 100vh;
                background-image      : url( /images/lama_bg_01.webp );
            }
    ...
    */
    //
    // but it didn't seem to help much so I removed the code above
    // 
    // remmeber, in order for <style is:inline></style> to work we need this :
    // <div className={ `${ styles.heroVideoContainer } hero-video-container` }></div>
    // ==============================
...
/*
                setTimeout( () => {
                    ...
                    // instantly hide lines before animating

                    // remember, we had to declare gsap.set() within the setTimeout in order to get
                    // all the lines in the h2 and h5 elements to separate
                    gsap.set( secondHeroH2Text.lines, { opacity: 0, x : -100 } );
                    gsap.set( secondHeroH5Text.lines, { opacity: 0, x : -100 } );

                    // animate the second hero h2 and h5 elements after 9400 ms
                    gsap.timeline( { delay : 0.150 } )
                        .to( secondHeroH2Text.lines,
                        ...
                        '-=2.20' ); // start 1.65s before the h2 animation ends and remember, use this
                        // number as our delay
...
*/
            ...
            // ==============================
                ...
                '-=1.60' ), // start 2.20s before the h2 animation ends and remember, use this
                // number as our delay
    ...
    return (
        ...
        <Fragment>
            ...
            <div className={ `${styles.heroVideoContainer} hero-video-container` }>
                ...
                <div>
...

                    {
                        /*
                            // ==============================
                            // turn videos off for mobile or under or equal to 620px
                            // ==============================
                        */
                    }

                    {
                        ...
                        /*!isMobile &&*/ videos.map( ( video, index ) => ( 
                            ...
                            <video
                                ...
                                preload='none' // If preload is not set, the default setting is metadata and preload=metadata tells the browser to download a percentage of the video ( typically 2-5% of the file ) to get metadata
                                key={ index }
...

                {
                    /*
                        ...
                        <h5>
                            ...
                            your online reputation, and ranking higher in local search results
                        </h5>
                        ...
                        <h5>
                            ...
                            operations experience to help your business grow faster and run smarter
                        </h5>
...

            {
                /*
                    // ==============================
                    // container 2 ( hero overlay div )
                    //
                    // initial color that slides off the screen on page load
                    //
                    // remember, we had to put this div outside the main container above in order to have
                    // run on it's own layer and thereby allowing us to animate both container 1 and container
                    // 2 at the same time
                    // ==============================
