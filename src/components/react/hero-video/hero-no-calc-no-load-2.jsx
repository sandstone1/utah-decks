...
import styles from './hero-no-calc-no-load-2.module.scss';
            ...
            <div className={ styles.heroVideoContainer }>
                ...
                >
                    ...
                    <h5>
                        ...
                        We specialize in <span style={ { color : 'var( --red-25 )' } }>local SEO</span>,{' '}
                        stunning websites, and{' '}
                        <span style={ { color : 'var( --red-25 )' } }>AI agents</span>{' '}
