...
import styles from './by-the-numbers-v3.module.scss';
...
export default function ByTheNumbersComponent() {
    ...
    // ==============================
    // purpose - create a counter animation for Google rating
    // ==============================
    ...
    useEffect( () => {
        ...
        // our target is 5.0 Google rating
        const target   = 5.0;
        const duration = 4000;
        ...
        const animate = ( timestamp ) => {
            ...
            */
            ...
            const current = Math.round( eased * target ).toFixed( 1 );
            ...
            if ( counterRefGoogleRating.current ) {

                // current will always be a number between 1.0 and 5.0 so use current
                counterRefGoogleRating.current.textContent = `${ current }`;
    ...
    useEffect( () => {
        ...
        // our target is 7+ years of experience
        const target   = 7;
        const duration = 4000;
        // performance.now() returns the current time in milliseconds since the page loaded and is
        // best for animations
        ...
        const animate = ( timestamp ) => {
            ...
            */
            ...
            // current will always be a number between 1 and 7 so use current
    ...
    useEffect( () => {
        ...
        // our target is 10 year warranty
        const target   = 10;
        const duration = 4000;
        // performance.now() returns the current time in milliseconds since the page loaded and is
        // best for animations
        ...
        const animate = ( timestamp ) => {
            ...
            */
            ...
            // current will always be a number between 1 and 10 so use current
            counterRefWarranty.current.textContent = `${ current } Years`;
    ...
    // ==============================
    // purpose - create a counter animation for 100% free estimates
    // ==============================
    ...
    useEffect( () => {
        ...
        // our target is 100% free estimates
        const target   = 100;
        const duration = 4000;
        // performance.now() returns the current time in milliseconds since the page loaded and is
        // best for animations
        ...
        const animate = ( timestamp ) => {
            ...
            */
            ...
            // current will always be a number between 1 and 100 so use current
            counterRefFreeEstimates.current.textContent = `${ current }% Free`;
                ...
                >
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div ref={ counterRefGoogleRating }></div>
                        ...
                        <div>
                            ...
                            <div ref={ counterRefFreeEstimates }></div>
