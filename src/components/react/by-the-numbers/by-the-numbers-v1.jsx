...
import styles from './by-the-numbers-v1.module.scss';
...
export default function ByTheNumbersComponent() {
    ...
    const counterRefRevenueGenerated   = useRef( null );
    const counterRefCustomWebAppsBuilt = useRef( null );
    const counterRefNumberUnoRankings  = useRef( null );
    const counterRefAIAgentsBuilt      = useRef( null );
    ...
    // ==============================
    // purpose - create a counter animation for revenue generated
    // ==============================
    ...
    useEffect( () => {
        ...
        // our target is $1 million dollars
        ...
        const animate = ( timestamp ) => {
            ...
            */
            const current = Math.round( ( eased * target ) / 10000 ) * 10000;
            ...
            counterRefRevenueGenerated.current.textContent = `$${ current.toLocaleString() }+`;
    ...
    // ==============================
    // purpose - create a counter animation for successful exits
    // ==============================
    ...
    useEffect( () => {
        ...
        // our target is 40+ fro custom web applications
        const target   = 40;
        const duration = 4000;
        // performance.now() returns the current time in milliseconds since the page loaded and is
        // best for animations
        ...
        const animate = ( timestamp ) => {
            ...
            */
            ...
            counterRefCustomWebAppsBuilt.current.textContent = `${ current }+`;
    ...
    // ==============================
    // purpose - create a counter animation for local seo #1 rankings
    // ==============================
    ...
    useEffect( () => {
        ...
        const animate = ( timestamp ) => {
            ...
            */
            ...
            // current will always be a number between 1 and 40 so use current
            counterRefNumberUnoRankings.current.textContent = `${ current }+`;
                ...
                >
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div ref={ counterRefRevenueGenerated }></div>

                        </div>

                        <div>

                            <p>Custom web apps built</p>

                            <div ref={ counterRefCustomWebAppsBuilt }></div>

                        </div>

                        <div>

                            <p>Google #1 rankings</p>

                            <div ref={ counterRefNumberUnoRankings }></div>
