...
import styles from './cimikoski-stem-cells.module.scss';
                ...
                <ul>
                    <li>Purpose of app:</li>
                        <ul>
                            ...
                            <li>rank higher in organic search results</li>
                    ...
                    <li>Please see below for two images from the app:</li>
                        ...
                        <a 
                            href="https://cimikoskistemcells.com/"
                            target="_blank" 
                        >
                            <img
                                src={ '/images/cimikoski_stem_cells_home_2.jpg' }
                        ...
                        <a
                            href="https://cimikoskistemcells.com/about"
                            target="_blank"
                        >
                            <img
                                src={ '/images/cimikoski_stem_cells_about_us.jpg' }
                                className={ styles.cimikoskiStemCellsWebsiteContainerImage2 }
                                loading={ 'lazy' }
                                alt={ 'Cimikoski Stem Cells lead magnet section' }
                            />
                        </a>

                    <li>
                        <a href="https://cimikoskistemcells.com/" target="_blank">Link to the website</a>
                    </li>
                </ul>
