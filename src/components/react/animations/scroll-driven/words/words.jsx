...
export default function WordsAnimationComponent() {
                ...
                entries.forEach( ( entry ) => {
                    ...
                    if ( entry.isIntersecting ) {
                        ...
                        const handleScroll = ( e ) => {
                            ...
                            if ( containerRef.current && wrapperRef.current && h2Ref.current && spanRef ) {
                                ...
                                // ==============================
                                // animation - fade in the h2 words
                                // part 2
                                // ==============================
                                ...
                                console.log( 'Second span element :', spanRef.current[ 1 ] );

                                // build the range with start and end

                                // start
                                let start =  ( index - 1 ) / words.length;

                                // set the star value
                                setStart( start );

                                // end
                                let end =  start + ( index / ( words.length * 2 ) ); // make the ending value about 50% smaller
                                ...
                                // end of build the range with start and end
                                ...
                                // fade in first word based on scroll position
                                if ( scrollPositionInsideDivPercentage > 0.075 && scrollPositionInsideDivPercentage <= 0.099 ) {

                                    console.log( 'first word' );

                                    spanRef.current[ 0 ].style.opacity    = 1;
                                    spanRef.current[ 0 ].style.transition = '200ms';

                                } // end of if

                                // fade in second word based on scroll position
                                else if ( scrollPositionInsideDivPercentage > 0.100 && scrollPositionInsideDivPercentage <= 0.124 ) {

                                    console.log( 'second word' );

                                    spanRef.current[ 1 ].style.opacity    = 1;
                                    spanRef.current[ 1 ].style.transition = '200ms';

                                } // end of else if

                                // fade in third word based on scroll position
                                else if ( scrollPositionInsideDivPercentage > 0.125 && scrollPositionInsideDivPercentage <= 0.149 ) {

                                    console.log( 'third word' );

                                    spanRef.current[ 2 ].style.opacity    = 1;
                                    spanRef.current[ 2 ].style.transition = '200ms';

                                } // end of else if

                                // fade in fourth word based on scroll position
                                else if ( scrollPositionInsideDivPercentage > 0.150 && scrollPositionInsideDivPercentage <= 0.174 ) {

                                    console.log( 'fourth word' );

                                    spanRef.current[ 3 ].style.opacity    = 1;
                                    spanRef.current[ 3 ].style.transition = '200ms';

                                } // end of else if

                                // catch all if statement, in case we don't catch all the words
                                // while scrolling
                                else if ( scrollPositionInsideDivPercentage > 0.175 ) {
                        ...
                        // this will get our h2 value or " Why Word With Us? "
                        let words = h2Ref.current.innerText.split( ' ' );

                        // show the array of 4 words
                        console.log( 'words :', [ ...words ] );

                        // [ ...words ] will create an array of 4 words
                        setWords( [ ...words ] );
    ...
    return (
        ...
        <Fragment>
            ...
            <div 
                className={ styles.wordsAnimationContainer }
                ref={ containerRef }
...
} // end of WordsAnimationComponent
