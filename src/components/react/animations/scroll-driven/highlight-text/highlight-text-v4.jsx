...
import styles from './highlight-text-v4.module.scss';
            ...
            function( entries, sectionObserver ) { 
                ...
                entries.forEach( ( entry ) => {
                    ...
                    if ( entry.isIntersecting ) {
                        ...
                        // scenario 1
                        //
                        // the user is above the about us or where you can find us section and the
                        // user is scrolling down the page, then do the following
                        //
                        ...
                        if ( entry.boundingClientRect.top > 0 ) {
                            ...
                            spanRef.current.classList.add( styles.isRevealed );

                        } // end of if ( entry.boundingClientRect.top > 0 ) {}

                        // ==============================
                        // scenario 2 & 3 will never happen but keep them here for referenece for now
                        // ==============================
                        ...
                        if ( 
                            ...
                            spanRef.current.style.backgroundPosition = "0%";
    ...
    return (
        ...
        <Fragment>
            ...
            >
                ...
                <a href='#'>
                    <span data-content="We are located in Lehi, Utah," aria-hidden="true" ref={ spanRef }></span>
                    We are located in Lehi, Utah,
                </a>
