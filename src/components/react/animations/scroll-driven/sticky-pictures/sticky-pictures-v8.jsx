...
// import SphereMeshDistortBlob from '../3d/react-three-fiber/lama-dev/sphere-6/sphere-mesh-distort-blob';
import { 
    gsap,
    ScrollTrigger,
    SplitText,
...
import styles from './sticky-pictures-v8.module.scss';
    ...
    useEffect( () => {
        ...
        */
        document.fonts.ready.then( () => {
            ...
            // had to set the opacity to 1 in order for the second h2 element to show on
            // the page after running the animation below
            secondH2Ref.current.style.opacity = 1;
            ...
            ctx = gsap.context(() => {
                ...
                const sectionTitleText = SplitText.create( '.sticky-pictures-h2', { 
                    type      : 'words, chars',
                    // type      : 'words, lines',
                    smartWrap : true,
                ...
                gsap.timeline(
                    {
                        scrollTrigger : {
                            trigger       : '.sticky-pictures-h2',         // element to watch
                            start         : 'top 80%',                  // waits until the div is 15% into view
                            /*
                            ┌─────────────────────┐  ← 0% (top of viewport)
                            │                     │
                            │                     │
                        ...
                        onComplete : () => {
                            // if ( contactBlobAnchorRef.current ) {
                                // contactBlobAnchorRef.current.style.borderBottom  = '0.3rem solid var( --gray-225 )';
                                // contactBlobAnchorRef.current.style.paddingBottom = '0'; // optional spacing
                            // }
                        }
                    }
                )
                .from( sectionTitleText.chars,
                    {
                        ...
                        */
                        ...
                        // fade-up with random stagger ( really good )
        ...
        >
            ...
            <div>
                ...
                <div>
                    ...
                    {
                        // ==============================
                        // take out my words animation and replace with the gsap animation
                        // ==============================
                        // ==============================
                        // to replace the words animation, I had to comment out the h2 below and
                        // comment out the spanRef above
                        // ==============================
                        /*
                            <h2>
