...
import AnimatingGradientBackground from '../../animating-gradient/animating-gradient-background-v9';
// import in Cube Component
import CubeComponent from '../../cube/cube-v1';
// import in the scss file
import styles from './sticky-pictures-v9.module.scss';
...
export default function StickyPicturesComponent() {
    ...
    useEffect( () => {
        ...
        const sectionOptions = {
            ...
            // root, then use: 0px 0px -80px 0px. "
                        ...
                        if ( entry.boundingClientRect.top > 0 ) {
                                ...
                                boxRef.current.animate(
                                    ...
                                    [
                                        ...
                                        }, 
                                        {
                                            ...
                                            transform : "rotate( 2000deg )" // control the speed to the rotation
                                        }
                                    ],
                                    {
                            ...
                            const handleScroll = ( e ) => {
                                ...
                                if ( 
                                    ...
                                    if ( scrollPositionInsideDivPercentage > 0.020 && scrollPositionInsideDivPercentage <= 0.030 ) {

                                        spanRef.current[ 0 ].style.opacity    = 1;
                                        // spanRef.current[ 0 ].style.transition = '300ms';
                                        // spanRef.current[ 0 ].style.transition = 'all 300ms cubic-bezier( 0.34, 1.56, 0.64, 1 )'; // very close to gsap back-out( 1.7 )
                                        spanRef.current[ 0 ].style.transition = 'all 600ms var( --back-out )'; // this is the gsap back-out( 1.7 )
                                        //spanRef.current[ 0 ].style.transition = 'all 2000ms var( --elastic-out )';
                                        spanRef.current[ 0 ].style.transform  = "translateX( 0 )";

                                    } // end of if

                                    // fade in and translate 2 word based on scroll position
                                    else if ( scrollPositionInsideDivPercentage > 0.030 && scrollPositionInsideDivPercentage <= 0.040 ) {

                                        spanRef.current[ 1 ].style.opacity    = 1;
                                        // spanRef.current[ 1 ].style.transition = '300ms';
                                        // spanRef.current[ 1 ].style.transition = 'all 300ms cubic-bezier( 0.34, 1.56, 0.64, 1 )';
                                        spanRef.current[ 1 ].style.transition = 'all 600ms var( --back-out )';
                                        //spanRef.current[ 1 ].style.transition = 'all 2000ms var( --elastic-out )';
                                        spanRef.current[ 1 ].style.transform  = "translateX( 0 )";

                                    } // end of else if

                                    // fade in and translate 3 word based on scroll position
                                    else if ( scrollPositionInsideDivPercentage > 0.040 && scrollPositionInsideDivPercentage <= 0.050 ) {

                                        spanRef.current[ 2 ].style.opacity    = 1;
                                        // spanRef.current[ 2 ].style.transition = '300ms';
                                        // spanRef.current[ 2 ].style.transition = 'all 300ms cubic-bezier( 0.34, 1.56, 0.64, 1 )';
                                        spanRef.current[ 2 ].style.transition = 'all 600ms var( --back-out )';
                                        //spanRef.current[ 2 ].style.transition = 'all 2000ms var( --elastic-out )';
                                        spanRef.current[ 2 ].style.transform  = "translateX( 0 )";

                                    } // end of else if

                                    // fade in and translate 4 word based on scroll position
                                    else if ( scrollPositionInsideDivPercentage > 0.050 && scrollPositionInsideDivPercentage <= 0.060 ) {

                                        spanRef.current[ 3 ].style.opacity    = 1;
                                        // spanRef.current[ 3 ].style.transition = '300ms';
                                        // spanRef.current[ 3 ].style.transition = 'all 300ms cubic-bezier( 0.34, 1.56, 0.64, 1 )';
                                        spanRef.current[ 3 ].style.transition = 'all 600ms var( --back-out )';
                                        //spanRef.current[ 3 ].style.transition = 'all 2000ms var( --elastic-out )';
                                        spanRef.current[ 3 ].style.transform  = "translateX( 0 )";

                                    } // end of else if

                                    // fade in and translate 5 word based on scroll position
                                    else if ( scrollPositionInsideDivPercentage > 0.060 && scrollPositionInsideDivPercentage <= 0.070 ) {

                                        spanRef.current[ 4 ].style.opacity    = 1;
                                        // spanRef.current[ 4 ].style.transition = '300ms';
                                        // spanRef.current[ 4 ].style.transition = 'all 300ms cubic-bezier( 0.34, 1.56, 0.64, 1 )';
                                        spanRef.current[ 4 ].style.transition = 'all 600ms var( --back-out )';
                                        //spanRef.current[ 4 ].style.transition = 'all 2000ms var( --elastic-out )';
                                        spanRef.current[ 4 ].style.transform  = "translateX( 0 )";

                                    } // end of else if

                                    // fade in and translate 6 word based on scroll position
                                    else if ( scrollPositionInsideDivPercentage > 0.070 && scrollPositionInsideDivPercentage <= 0.080 ) {

                                        spanRef.current[ 5 ].style.opacity    = 1;
                                        // spanRef.current[ 5 ].style.transition = '300ms';
                                        // spanRef.current[ 5 ].style.transition = 'all 300ms cubic-bezier( 0.34, 1.56, 0.64, 1 )';
                                        spanRef.current[ 5 ].style.transition = 'all 600ms var( --back-out )';
                                        //spanRef.current[ 5 ].style.transition = 'all 2000ms var( --elastic-out )';
                                        spanRef.current[ 5 ].style.transform  = "translateX( 0 )";

                                        console.log( scrollPositionInsideDivPercentage );
                                    } // end of else if

                                    // fade in and translate 7 word based on scroll position
                                    else if ( scrollPositionInsideDivPercentage > 0.080 && scrollPositionInsideDivPercentage <= 0.090 ) {

                                        spanRef.current[ 6 ].style.opacity    = 1;
                                        // spanRef.current[ 6 ].style.transition = '300ms';
                                        // spanRef.current[ 6 ].style.transition = 'all 300ms cubic-bezier( 0.34, 1.56, 0.64, 1 )';
                                        spanRef.current[ 6 ].style.transition = 'all 600ms var( --back-out )';
                                        //spanRef.current[ 6 ].style.transition = 'all 2000ms var( --elastic-out )';
                                        spanRef.current[ 6 ].style.transform  = "translateX( 0 )";

                                    } // end of else if

                                    // fade in and translate 8 word based on scroll position
                                    else if ( scrollPositionInsideDivPercentage > 0.090 && scrollPositionInsideDivPercentage <= 0.100 ) {

                                        spanRef.current[ 7 ].style.opacity    = 1;
                                        // spanRef.current[ 7 ].style.transition = '300ms';
                                        // spanRef.current[ 7 ].style.transition = 'all 300ms cubic-bezier( 0.34, 1.56, 0.64, 1 )';
                                        spanRef.current[ 7 ].style.transition = 'all 600ms var( --back-out )';
                                        //spanRef.current[ 7 ].style.transition = 'all 2000ms var( --elastic-out )';
                                        spanRef.current[ 7 ].style.transform  = "translateX( 0 )";

                                    } // end of else if

                                    // catch all if statement, in case we don't catch all the words
                                    // while scrolling
                                    else if ( scrollPositionInsideDivPercentage > 0.100 || scrollPositionInsideDivPercentage <= -0.000 ) {
                                    ...
                                    if (
                                        ...
                                        spanRef.current[ 5 ].style.margin  = '0 0.73rem 0 0';
                                        spanRef.current[ 6 ].style.margin  = '0 0.73rem 0 0';
                                        spanRef.current[ 7 ].style.margin  = '0 0.73rem 0 0';
                                    ...
                                    // by waiting until the fourthBlock === true, we show the
                                    // percentage indicator at the same time as the rudder
                                    if ( fourthBlock === true ) {

                                        const percentage                       = ( scrollPositionInsideDivPercentage * 100 ).toFixed( 1 );
                                        percentageRef.current.textContent      = `${ percentage }%`;
                                        percentageRef.current.style.transition = 'opacity 800ms ease-out 200ms';
                                        percentageRef.current.style.opacity    = '1';

                                    } // end of if ()

                                    // ==============================
                                    // end of show percentage indicator
                                    // ==============================
                                    ...
                                    if ( 
                                        ...
                                        if ( fourthBlock === true && fifthBlock === false ) {
                                            ...
                                            if ( CSS.supports( 'animation-timeline : scroll()' ) ) {
                                                ...
                                                h2Ref.current.style.transition = 'opacity 800ms ease-out 200ms';
...
*/
                            ...
                            // get the h2 text
                            const wordsText = 'Reason 7 - increase engagement with custom animations';
            ...
            <div>
                ...
                <div>

                    {
                        /*
                            // ==============================
                            // container > div 1 > div 1 > h2 ( the h2 word animation )
                            // ==============================
                        */
                    }
...

                    {
                        ...
                        words ? ( // remember, we set words in useEffect 1 above and we are running this animation not the h2 below

                            words.map( ( word, i ) => {

                                // style custom animations differently that the rest of the h2
                                const accentWords = [ 'custom', 'animations' ];
...

                    {
                        /*
                            // ==============================
                            // container > div 1 > div 1 > h2 ( static h2 ) ( remember, only one h2 will run and see the code above for details )
                            // ==============================
                        */
                    }
                    <h2
                        ...
                        ref={ secondH2Ref }
                    >
                        Reason 7 - increase engagement with <span style={ { color : 'var( --green-23-5 )' } }>custom animations</span>
                    </h2>
...

                {
                    /*
                        // ==============================
                        // container > div 1 > div 2 ( box ) ( box that contains the rudder image )
                        // ==============================
                    */
                }
                <div
                ...
                >

                    {
                        /*
                            // ==============================
                            // container > div 1 > div2 > picture ( picture of rudder )
                            // ==============================
...

                {
                    /*
                        // ==============================
                        // container > div 1 > div 3 ( fallback message )
                        // ==============================
                    */
                }
                <div
                    ref={ h2Ref }
                >
                    Sorry, your browser does not support this animation
                </div>

                {
                    /*
                        // ==============================
                        // container > div 1 > div 4 ( percentage indicator showing how far through the div )
                        // ==============================
                    */
                }
                <div
                ...
                <div>

                    {
                        /*
                            // ==============================
                            // container > div 1 > div 4 > div 1 ( card 1 )
                            // ==============================
                        */
                    }
                    <div
                    ...
                    >

                        {
                            /*
                                // ==============================
                                // container > div 1 > div 4 > div 1 ( card 1 ) > picture ( picture of old typewriter )
                                // ==============================
                        ...
                        <picture>
                            <source 
                                srcSet={ '/images/card_image_16_600.jpg' }
                                type={ 'image/webp' }
                            />
                            <img
                                src={ '/images/card_image_16_600.jpg' }
                                width={ 600 }
                                height={ 600 }
                                loading={ 'lazy' }
                                // fetchPriority={ 'high' }
...

                    {
                        /*
                            // ==============================
                            // container > div 1 > div 4 > div 2 ( card 2 )
                            // ==============================
                        */
                    }
                    <div
                    ...
                    >

                        {
                            /*
                                // ==============================
                                // container > div 1 > div 4 > div 2 ( card 2 ) > picture ( picture of old camera )
                                // ==============================
                        ...
                        <picture>
                            <source 
                                srcSet={ '/images/card_image_14_600.webp' }
                                type={ 'image/webp' }
                            />
                            <img
                                src={ '/images/card_image_14_600.jpg' }
                                width={ 600 }
                                height={ 600 }
                                loading={ 'lazy' }
                                // fetchPriority={ 'high' }
...

                    {
                        /*
                            // ==============================
                            // container > div 1 > div 4 > div 3 ( card 3 )
                            // ==============================
                        */
                    }
                    <div
                    ...
                    >

                        {
                            /*
                                // ==============================
                                // container > div 1 > div 4 > div 3 ( card 3 ) > picture ( picture of house )
                                // ==============================
                        ...
                        <picture>
                            <source 
                                srcSet={ '/images/card_image_13_600.webp' }
                                type={ 'image/webp' }
                            />
                            <img
                                src={ '/images/card_image_13_600.jpg' }
                                width={ 600 }
                                height={ 600 }
                                loading={ 'lazy' }
                                // fetchPriority={ 'high' }
...

                    {
                        /*
                            // ==============================
                            // container > div 1 > div 4 > div 4 ( card 4 )
                            // ==============================
                        */
                    }
                    <div
                    ...
                    >

                        {
                            /*
                                // ==============================
                                // container > div 1 > div 3 > div 4 ( card 4 ) > picture ( picture of fashionable woman )
                                // ==============================
                        ...
                        <picture>
                            <source 
                                srcSet={ '/images/card_image_17_600.webp' }
                                type={ 'image/webp' }
                            />
                            <img
                                src={ '/images/card_image_17_600.jpg' }
                                width={ 600 }
                                height={ 600 }
                                loading={ 'lazy' }
                                // fetchPriority={ 'high' }
...

                {
                    /*
                        // ==============================
                        // container > div 1 > div 5 ( image background )
                        // ==============================
                    */
                }
                <div
        ...
        
                {
                    /*
                        // ==============================
                        // container > div 1 > div 6 ( animating backgrounds )
                        // ==============================
                    */
                }
                <div
