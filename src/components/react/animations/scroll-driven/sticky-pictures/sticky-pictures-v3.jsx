...
import styles from './sticky-pictures-v3.module.scss';
                ...
                entries.forEach( ( entry ) => {
                    ...
                    if ( entry.isIntersecting ) {
                        ...
                        const handleScrollTwo = ( e ) => {
                            ...
                            // if statement
                            if ( window.scrollY > 10000 && containerRef.current ) {

                                containerRef.current.style.position = 'relative';
                    
                            } // end of if ( window.scrollY > 10000 )

                            // else if statement
                            else if ( window.scrollY <= 10000 && containerRef.current ) {

                                containerRef.current.style.position = 'sticky';
                    
                            } // end of else if ( window.scrollY <= 10000 )
