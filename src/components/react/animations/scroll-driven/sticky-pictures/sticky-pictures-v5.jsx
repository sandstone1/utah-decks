                    ...
                    if ( entry.isIntersecting ) {
                                    ...
                                    if ( 
                                        ...
                                        if ( fourthBlock === true && fifthBlock === false ) {
                                            ...
                                            if ( CSS.supports( 'animation-timeline : scroll()' ) ) {
                                                ...
                                                boxH5Ref.current.style.opacity = 0;
                                            }
                                            else {

                                                boxH5Ref.current.animate(
                        ...
                        if ( entry.boundingClientRect.top <= 0 ) {
                            ...
                            if ( CSS.supports( 'animation-timeline : scroll()' ) ) {
                                ...
                                boxH5Ref.current.style.opacity                  = 1; // show
                                boxH5Ref.current.style.transitionDuration       = '400ms';
                                boxH5Ref.current.style.transitionTimingFunction = 'ease-out';
        ...
        <div>
            ...
            <div>

                {
                    /*
                        // ==============================
                        // container > div 1 ( wrapper div ) > h2 ( the h2 word animation )
                        // ==============================
                    */
                }
...

                {
                    /*
                        // ==============================
                        // container > div 1 ( wrapper div ) > h2 ( static h2 ) ( remember, only one h2 will run and see the code above for details )
                        // ==============================
                    */
                }
                <h2
            ...
            >
                ...
                <h5
                    ref={ boxH5Ref }
                >
                    {/* Your browser does not support the rudder rotation animation. Please keep scrolling. */}
                </h5>
