...
import styles from './sticky-pictures-v2.module.scss';
...
export default function CustomAnimationsComponent() {
    ...
    // the useEffect hook will run after the initial page load and then the useEffect hook
    // will be called each time the browserWidth changes 
    useEffect( () => {
    ...
    return (
        ...
        >
...

            {
                /*
                    // ==============================
                    // container > div 2 ( rotating box ) ( box moving across the screen from left to right based on scroll )
                    // ==============================
                */
            }
            <div
            ...
            }
            {
                /*
                    // ==============================
                    // container > div 5 ( wave container )
                    // ==============================
                */
            }
            <div>
