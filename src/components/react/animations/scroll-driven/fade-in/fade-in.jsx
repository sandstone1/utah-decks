...
export default function FadeInAnimationComponent() {
                ...
                entries.forEach( ( entry ) => {
                    ...
                    if ( entry.isIntersecting ) {
                        ...
                        const handleScroll = ( e ) => {
                            ...
                            if ( containerRef.current && wrapperRef.current && h2Ref.current ) {
                                ...
                                // ==============================
                                // fade in the wrapper div
                                // ==============================

                                // to change the fade in effect, change the multiplier
                                wrapperRef.current.style.opacity = scrollPositionInsideDivPercentage * 3.6;

                                // show the opacity of the wrapper div
                                console.log( 'opacity :', wrapperRef.current.style.opacity );

                                // ==============================
                                // end of fade in wrapper div
                                // ==============================
                        ...
                        // ==============================
                        // animation - fade in the contents of the section
                        // part 1
                        // ==============================
    ...
    return (
        ...
        <Fragment>
            ...
            <div 
                className={ styles.fadeInAnimationContainer }
                ref={ containerRef }
            ...
            >
                ...
                <div
                    ref={ wrapperRef }
                    style={ { opacity : 0 } } // for the fade in animation effect
                >
...
} // end of FadeInAnimationComponent
