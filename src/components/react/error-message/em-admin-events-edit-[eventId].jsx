...
import styles from './em-admin-events-edit-[eventId].module.scss';
...
export default function ErrorMessageComponent( { children, resetFrontendErrorMessage, fetchEvents } ) {
