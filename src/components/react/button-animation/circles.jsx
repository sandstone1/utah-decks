...
export default function CirclesComponent() {
    ...
    async function handleParticleClick( e ) {
        ...
        for ( let i = 0; i < 30; i++ ) {
            ...
            createParticleCircle( e.clientX, e.clientY );
    ...
    // ==============================
    // button particle animation - circle
    // ==============================

    async function createParticleCircle( x, y ) {
        ...
        // generate a random color in a blue / purple palette and we need to use hsl here
        // and see the following the w3 schools site for details :
        // " https://www.w3schools.com/colors/colors_hsl.asp "

        // create a hue value between 180 and 270
        particle.style.background = `hsl( ${ Math.random() * 90 + 180 }, 70%, 60% )`;

        // generate a random x & y destination within a distance of 75px from the mouse

        // generate a random x & y destination
        // the x value will be both negative and positive within a distance of 75px from the mouse
        // the y value will be both negative and positive within a distance of 75px from the mouse
        ...
        // so we can remove the element with animation.onfinish
        const animation = particle.animate(

            [
                {
                    // transform : `translate( ${ x - ( size / 2 ) }px, ${ y - ( size / 2 ) }px )`, // the article transform
                ...
                {
                    // transform : `translate( ${ destinationX }px, ${ destinationY }px )`, // the article transform
    ...
    } // end of createParticleCircle function
