...
import styles from './contact-form-postmark-badge.module.scss';
            ...
            function( entries, sectionObserver ) { 
                ...
                entries.forEach( ( entry ) => {
                    ...
                    if ( entry.isIntersecting ) {
                        ...
                        if ( 
                            ...
                            wrapperRef.current.animate(
                                ...
                                [
                                    ...
                                    {
                                        opacity   : 0,
                                        transform : "translateY( 6.0rem )" // could not get transform
                                        // to work smoothly in conjunction with reCAPTCHA but remember,
                                        // we were able to get it to work in Cimikoski Stem Cells since
                                        // the container is low enough that we could use the intersection
                                        // observer to delay the loading of reCAPTCHA in that app
                                    }, 
                                    {
                                        opacity   : 1,
                        ...
                        // ==============================
                        // browserWidth <= 1376 && browserWidth > 768
                        // ==============================
                ...
                isLoading ? (
                    ...
                    */
                    ...
                    >
                        ...
                        <picture>
                            <source 
                                srcSet={ '/images/line_art_26.webp' }
                                type={ 'image/webp' }
                            />
                            <img
                                src={ '/images/line_art_26.png' }
                                width={ '512px' }
                                height={ '512px' }
                                // loading={ 'lazy' }
                                fetchpriority={ 'high' }
                        ...
                        <form className={ styles.contactFormContainerForm } noValidate="novalidate" onSubmit={ handleSubmit }>

                            {
                                /*
                                    // ==============================
                                    // container > form > div > input ( input field - name )
                                    // ==============================
                                */
                            }
...

                            {
                                /*
                                    // ==============================
                                    // container > form > div > input ( input field - email )
                                    // ==============================
                                */
                            }
...

                            {
                                /*
                                    // ==============================
                                    // container > form > div > input ( text area field - message )
                                    // ==============================
                                */
                            }
...

                            {
                                /*
                                    ...
                                    // ==============================
                                    // remember, reCAPCHTA was causing the page transition to be janky so we decided
                                    // to turn off the transform function in useEffect 1 and just use opacity and
                                    // that worked
                                    // ==============================
                                */
                            }
...

                            {
                                /*
                                    // ==============================
                                    // Google reCAPTCHA language that is needed if we
...

                            {
                                /*
                                    // ==============================
                                    // container > form > div > button ( submit button )
                                    // ==============================
                                */
                            }
...

                        {
                            /*
                                // ==============================
                                // container > div ( orange background circle )
                                // ==============================
                            */
                        }
                        <div></div>
