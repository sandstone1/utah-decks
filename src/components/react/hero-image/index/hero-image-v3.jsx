...
import styles from './hero-image-v3.module.scss';
...
*/
        ...
        setTimeout( () => {
            ...
            if ( div1Ref.current && div2Ref.current ) {
                ...
                // show div34after 400ms and this will start the animation process ( see the
                // css file for details on the animation )
...
*/
                ...
                // number as our delay
/*
                gsap.timeline( { delay : 3.450 } )
                    .from( div4Ref.current, 
                        {
                            opacity  : 0,
                            duration : 2.4,
                            delay    : 0.0,
                    ...
                    '-=2.40' ); // start 1.30s before the h2 animation ends )
*/
                setTimeout( () => {
...
/*
                    // I had these since fill : "forwards" from useEffect 1 was holding both 
                    // elements off screen and at an opacity of 0
                    div3Ref.current.getAnimations().forEach(anim => anim.cancel());
                    div4Ref.current.getAnimations().forEach(anim => anim.cancel());
        ...
        <Fragment>
            ...
            <div className={ `${styles.heroImageContainer} hero-image-container` }>
                ...
                <div>
                    ...
                    >
                        ...
                        <h5 className="first-hero-h5">
                            We specialize in healing orthopedic injuries{' '}
                            naturally — using the body&apos;s own ability to{' '}
                            <span style={{ color: 'var(--gold-42  )' }}>repair</span>{' '}
                            and <span style={{ color: 'var(--gold-42  )' }}>regenerate</span>
                        </h5>
                    ...
                    >
                        ...
                        <h2 className="second-hero-h2">
                            Wellness that goes beyond the joint
                        </h2>

                        <h5 className="second-hero-h5">
                            We offer bioidentical hormone replacement therapy,{' '}
                            peptide therapy, and{' '}
                            platelet-rich plasma therapy
                            to help you feel <span style={{ color: 'var(--gold-42 )' }}>stronger</span> and{' '}
                            <span style={{ color: 'var(--gold-42 )' }}>more balanced at any age</span>
                        </h5>
                ...
                <div>
                    ...
                    <div
                        ref={ div3Ref }
                        className="third-hero-free-consult"
                    >
                        <a href="#">
                    ...
                    <div
                        ref={ div4Ref }
                        className="third-hero-phone-number"
                    >
                        <a
                ...
                <div>
                    ...
                    <div>
                        <span>
                            <BsShieldCheck style={ { verticalAlign: '-6.0px', fontSize: '2.2rem', margin: '0 1.0rem 0 0' } } />
                            Licensed & Insured
                        </span>
                    </div>
