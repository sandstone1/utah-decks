...
import styles from './sm-image-upload-to-cloudinary-node-sdk.module.scss';
...
export default function SuccessMessageComponent( { children, resetFrontendSuccessMessage, resetUploadedImagePathGeneral } ) {
