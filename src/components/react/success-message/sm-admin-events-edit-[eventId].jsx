...
import styles from './sm-admin-events-edit-[eventId].module.scss';
...
export default function SuccessMessageComponent( { children, resetFrontendSuccessMessage, fetchEvents } ) {
    ...
    const handleClick = ( e ) => {
        ...
        // after closing the error message, call the fetchEvents function
        fetchEvents();
