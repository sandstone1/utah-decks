...
import styles from './sm-image-upload-to-cloudinary-unsigned.module.scss';
...
export default function SuccessMessageComponent( { children, resetFrontendSuccessMessage, resetUploadedImagePath } ) {
